import type { ActualizarAutoDTO, AutoConSlug, CrearAutoDTO, EstadisticasDashboard, EstadoAuto } from "../tipos";
...
export interface IAutoRepositorio {
  ...
  actualizarAuto(id: number, datos: ActualizarAutoDTO): Promise<AutoConSlug | undefined>;
