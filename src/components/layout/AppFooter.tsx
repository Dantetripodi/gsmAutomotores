...
export function AppFooter({ onNavigate }: Props) {
    ...
    <footer className="bg-neutral-900 text-white">
      <div className="max-w-7xl mx-auto px-4 md:px-8 pt-12 pb-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          <div>
            ...
            <div className="flex items-center gap-3 mt-5">
              <a
                ...
                className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#b80c0c] flex items-center justify-center transition-colors"
              >
                <IconInstagram />
              </a>
              <a
          ...
          {/* Navegación */}
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-widest text-neutral-500 mb-4">Navegación</h3>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-neutral-400">
              ...
              <li>
                <a href="mailto:info@gsmautomotores.com.ar" className="hover:text-white transition-colors">
                  info@gsmautomotores.com.ar
                </a>
              </li>
              <li>
                <a
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-neutral-600">
          <p>© {year} GSM Automotores. Todos los derechos reservados.</p>
          <p>Los precios son referenciales y pueden variar sin previo aviso.</p>
        </div>
      </div>
    </footer>
  );
